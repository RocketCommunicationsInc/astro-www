...
|       | `--Grey800Color`       | `hsl(220 5% 24.7%)`  | Compliannce widget border color, Playground panel header text color                                                                                                        |
|       | `--Grey900Color`       | `hsl(225 5% 16.86%)` | Contribution footer dividing line, Playground  panel body text color                                                                                                       |
...
|       | `--Orange600Color`     | `hsl(35 100% 62%)`   | Homepage link color                                                                                                                                                        |
...
|       | `--Purple300Color`     | `hsl(250 54% 78%)`   | not in use                                                                                                                                                                 |
|       | `--Red500Color`        | `hsl(0 100% 61%)`    | not in use                                                                                                                                                                 |
|       | `--Red800Color`        | `hsl(9 96% 28%)`     | not in use                                                                                                                                                                 |
