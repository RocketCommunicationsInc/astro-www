...
setup: |
  ...
  let stats = fs.statSync(new URL(import.meta.url))
  Astro.props.date = stats.mtime.toLocaleDateString()
---
...
![Don’t: Go over one line of Help Text. Use a Pop Over instead for text that is too long.](/img/patterns/val-help-text-dont-2.png "Don’t: Go over one line of Help Text. Use a Pop Over instead for text that is too long.")
:::
