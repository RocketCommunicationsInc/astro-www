...
class OrbitVisualizer extends HTMLElement {
  ...
  constructor() {
    ...
    // Don't use shadow DOM - render directly to light DOM for simplicity
      ...
      <div class="orbit-container">
        ...
        <div class="controls">
          <div class="control-group">
            ...
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-leo" checked>
                <span>Low Earth Orbit (LEO)</span>
              </label>
            </div>
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-meo">
                <span>Medium Earth Orbit (MEO)</span>
              </label>
            </div>
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-geo">
                <span>Geostationary Orbit (GEO)</span>
              </label>
            </div>
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-polar">
                <span>Polar Orbit</span>
              </label>
            </div>
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-sunSync">
                <span>Sun-Synchronous Orbit</span>
              </label>
            </div>
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-heo">
                <span>Highly Elliptical Orbit (HEO)</span>
              </label>
            </div>
          </div>
          ...
          <div class="control-group">
            ...
            <div class="control-item">
              <label class="checkbox-label">
                <input type="checkbox" class="checkbox-input" id="show-animation" checked>
  ...
  createAllOrbits() {
    // For each orbit type
    Object.entries(OrbitVisualizer.defaultOrbitParams).forEach(
      ([key, params]) => {
  ...
  updateSatellitePositions(time) {
    ...
    Object.entries(this.satellites).forEach(([key, satelliteGroup]) => {
      ...
      const params = OrbitVisualizer.defaultOrbitParams[key];
      if (!params) return;
...
customElements.define("orbit-visualizer", OrbitVisualizer);
