...
export default class PanelNavItem extends HTMLElement {
 constructor() {
		...
		const svg: {[key:string]: string} = {
			...
			'Slots': `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><title>Examples</title><path d="M4 9c.55 0 1-.45 1-1s-.45-1-1-1-1 .45-1 1 .45 1 1 1Zm1 3c0 .55-.45 1-1 1s-1-.45-1-1 .45-1 1-1 1 .45 1 1Zm0 4c0 .55-.45 1-1 1s-1-.45-1-1 .45-1 1-1 1 .45 1 1Zm15-3H8c-.55 0-1-.45-1-1s.45-1 1-1h12c.55 0 1 .45 1 1s-.45 1-1 1ZM8 17h12c.55 0 1-.45 1-1s-.45-1-1-1H8c-.55 0-1 .45-1 1s.45 1 1 1Zm0-8c-.55 0-1-.45-1-1s.45-1 1-1h12c.55 0 1 .45 1 1s-.45 1-1 1H8Z"></path></svg>`
		}
...
// <button data-nav-item="Slots"></button>
// <button data-nav-item="Properties"></button>
// <button ></button>
